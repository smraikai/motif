...
xcrun swiftc -swift-version 5 -module-cache-path .build/ModuleCache Sources/Models.swift Sources/YouTubeClient.swift Sources/PreparedAudio.swift Sources/StreamResolver.swift Sources/PlayerStore.swift Tests/StoreTests.swift -o .build/check-store
.build/check-store
xcrun swiftc -swift-version 5 -module-cache-path .build/ModuleCache Sources/Models.swift Sources/YouTubeClient.swift Sources/PreparedAudio.swift Sources/StreamResolver.swift Sources/PlayerStore.swift Sources/PlayerTheme.swift Sources/ArtworkLoadingView.swift Sources/PlayerViewController.swift Tests/InteractionTests.swift -o .build/check-interactions
...
xcrun swiftc -swift-version 5 -module-cache-path .build/ModuleCache Sources/Models.swift Sources/YouTubeClient.swift Sources/PreparedAudio.swift Sources/StreamResolver.swift Sources/PopoverHitTest.swift Tests/StreamResolverTests.swift -o .build/check-resolver
